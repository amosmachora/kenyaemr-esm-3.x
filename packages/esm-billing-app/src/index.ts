...
import { RefundLineItem } from './billable-services/bill-manager/modals/refund-line-item.modal';
...
export const refundLineItemModal = getSyncLifecycle(RefundLineItem, options);
